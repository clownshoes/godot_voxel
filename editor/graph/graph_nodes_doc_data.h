...
static const Node g_data[COUNT] = {
    ...
    {"Curve", "Mapping", "Returns the value of a custom [code]curve[/code] at coordinate [code]x[/code], where [code]x[/code] is in the range specified by its domain properties (in Godot 4.3 and earlier, it is in [code][0..1][/code]). The [code]curve[/code] is specified with a [url=Curve]Curve[/url] resource."},
